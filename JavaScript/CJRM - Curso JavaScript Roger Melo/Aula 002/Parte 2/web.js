...
const emailReplace = email.replace('l', 'y') // O replace irá SUBSTITUIR o caractere de uma string, por outro! O primeiro argumento, é a string que queremos substituir, e o segundo, será o substituto. Também posso subistuir por palavras, ex: 'leonardocarmo941', 'leozinho'. Não altera o valor Original.
