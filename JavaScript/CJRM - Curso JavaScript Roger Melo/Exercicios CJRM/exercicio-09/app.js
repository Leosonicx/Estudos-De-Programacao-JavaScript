...
console.log(isItemIncluded(2, [7,7,1]))
...
const isNo = value => value === null 
console.log(isNo(null))
...
console.log(getLikesMessage(['Luffy', 'Shin', 'Goku', 'Ippo', 'Naruto']))